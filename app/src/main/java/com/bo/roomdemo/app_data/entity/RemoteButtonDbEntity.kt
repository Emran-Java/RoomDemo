...
data class RemoteButtonDbEntity(
    ...
    @ColumnInfo(name = "button_text_color") val buttonTextColor: String?, //store button color code
    ...
    @ColumnInfo(name = "button_is_show_text") val buttonIsShowText: Boolean = true,//store true false
    @ColumnInfo(name = "button_is_enable") val buttonIsEnable: Boolean = true,//store true false
)
